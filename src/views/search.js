...
const result = (items) => html `<h4>Results:</h4>
<div class="search-result">
${items.length === 0 ? 
html `<p class="no-result">No result.</p>` : items.map(item => fruitCardTemp(item))
}

</div>`

const fruitCardTemp = (item) => html `<div class="fruit">
